...
public enum Packets {
	...
	public static final ResourceLocation CHANNEL_NAME = grimoire_of_tetra.asId("network");
	public static final String NETWORK_VERSION = grimoire_of_tetra.asId("1").toString();
